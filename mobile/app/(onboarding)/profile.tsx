...
const styles = StyleSheet.create({
  ...
  avatarPlaceholder: { width: AVATAR_SIZE, height: AVATAR_SIZE, borderRadius: AVATAR_SIZE / 2, backgroundColor: colors.mist, borderWidth: 1, borderColor: colors.control, alignItems: 'center', justifyContent: 'center' },
  ...
  input:             { backgroundColor: colors.mist, borderRadius: radius.md, padding: spacing.md, color: colors.breath, fontFamily: 'Inter_400Regular', fontSize: 16, borderWidth: 1, borderColor: colors.control },
