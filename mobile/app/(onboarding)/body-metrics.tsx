...
const styles = StyleSheet.create({
  ...
  segment:    { flex: 1, alignItems: 'center', paddingVertical: spacing.md, backgroundColor: colors.mist, borderRadius: radius.md, borderWidth: 1, borderColor: colors.control },
  segmentActive: { backgroundColor: colors.pulse, borderColor: colors.pulse },
  field:      { backgroundColor: colors.mist, borderRadius: radius.md, padding: spacing.md, borderWidth: 1, borderColor: colors.control },
  picker:     { alignSelf: 'center' },
  stepper:    { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.mist, borderRadius: radius.md, borderWidth: 1, borderColor: colors.control, paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
